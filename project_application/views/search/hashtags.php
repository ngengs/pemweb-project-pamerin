	...
	<div class="row">
		<div class="cards-column-half-litle cards-column-center">
			<ul class="nav nav-inverted margin-bottom-md nav-pills nav-justified">
			  <li role="presentation"><a href="<?php echo base_url($this->config->item('url_search_user').$search);?>">User</a></li>
			  <li role="presentation" class="active"><a href="<?php echo base_url($this->config->item('url_search_hashtags').$search);?>">Hashtags</a></li>
			</ul>
		</div>
	</div>
...
?>
	<div class="cards-column-half-litle cards-column-center">
		<div class="alert alert-warning">Searching <?php echo $search;?> Not Found</div>
	</div>
