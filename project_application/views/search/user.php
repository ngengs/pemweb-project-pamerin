	...
	<?php } ?>
		<div class="cards-column-half-litle cards-column-center">
			<ul class="nav nav-inverted margin-bottom-md nav-pills nav-justified">
			  <li role="presentation" class="active"><a href="<?php echo base_url($this->config->item('url_search_user').$search);?>">User</a></li>
			  <li role="presentation"><a href="<?php echo base_url($this->config->item('url_search_hashtags').$search);?>">Hashtags</a></li>
			</ul>
		</div>
 		<div class="cards-column-half cards-column-center">
				<article class="cards">
								...
								<li class="media">
								    ...
								    <div class="media-body">
								    	<div class="media-heading">
								    		...
								    		<div class="list-title-small"><?php $value->FULL_NAME;?></div>
								    	</div>
			...
			<?php if(empty($user)){ ?>
				<div class="cards-column-half-litle cards-column-center">
					<div class="alert alert-warning">Searching User <?php echo $search;?> Not Found</div>
				</div>
			<?php } ?>